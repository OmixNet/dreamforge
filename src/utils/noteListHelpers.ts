...
export function isInFolder(entryPath: string, folderRelPath: string): boolean {
...
export function pathRelativeToRoot(entryPath: string, rootPath?: string): string | null {
  const normalizedRootPath = rootPath ? normalizeFolderPath(rootPath) : ''
