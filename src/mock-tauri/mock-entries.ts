...
// DREAMFORGE_SLIM: 5-entry structure mock for dreamforge-test-vault
// Used by SlimSidebar to count Notes / Wiki / Memory / Raw / Archive entries
// in the default dev vault. Counts at this point: Notes 1, Memory 1, Raw 1.
// Timestamps are hardcoded to 2026-06-15 (Unix seconds) for stable display in
// Slim mode (the module-level `now` constant evaluates at import time and
// interacts poorly with date math across month boundaries).
const DREAMFORGE_MOCK_BASE_TS = Math.floor(new Date('2026-06-15T00:00:00Z').getTime() / 1000)
MOCK_ENTRIES.push(
  {
    ...
    status: null,
    archived: false,
    modifiedAt: DREAMFORGE_MOCK_BASE_TS,
    createdAt: DREAMFORGE_MOCK_BASE_TS - 86400,
    fileSize: 256,
    snippet: 'A sample note inside the notes/ folder.',
    wordCount: 12,
    relationships: {},
  ...
  },
  {
    ...
    archived: false,
    modifiedAt: DREAMFORGE_MOCK_BASE_TS,
    createdAt: DREAMFORGE_MOCK_BASE_TS - 86400 * 2,
    fileSize: 192,
    snippet: 'Long-term memory index file for the vault.',
    wordCount: 8,
    relationships: {},
    icon: null, color: null, order: null, sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
  ...
  {
    path: '/Users/biomatrix/Desktop/APP/dreamforge-test-vault/raw/2026-06-15-source.md',
    filename: '2026-06-15-source.md',
    title: 'Source 1',
    isA: null,
    aliases: [],
    belongsTo: [],
    ...
    status: null,
    archived: false,
    modifiedAt: DREAMFORGE_MOCK_BASE_TS - 86400,
    createdAt: DREAMFORGE_MOCK_BASE_TS - 86400,
    fileSize: 128,
    snippet: 'Raw import material — read-only in Slim mode.',
    wordCount: 6,
    relationships: {},
    icon: null, color: null, order: null, sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
