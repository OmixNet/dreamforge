...
// DREAMFORGE_SLIM: hasDurableEditorBlocks 物理删除 (PR 8, editorDurableMarkdown 删)
import {
...
export function syncActiveTabIntoRawBuffer(options: {
  ...
  const shouldSerializeRichEditorContent = serializeRichEditorContent || false // DREAMFORGE_SLIM: hasDurableEditorBlocks 物理删除 (PR 8)
