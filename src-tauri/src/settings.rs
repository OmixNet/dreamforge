...
const APP_CONFIG_DIR: &str = "com.biomatrix.dreamforge";
const LEGACY_APP_CONFIG_DIR: &str = "com.laputa.app";
// DREAMFORGE_SLIM: SUPPORTED_DEFAULT_AI_AGENTS 物理删除 (PR 4, 12 个 AI module 全删)
...
// DREAMFORGE_SLIM: AiWorkspaceConversationSetting struct 物理删除 (PR 4)
...
// DREAMFORGE_SLIM: normalize_default_ai_agent fn 物理删除 (PR 4)
...
// DREAMFORGE_SLIM: normalize_ai_workspace_conversations fn 物理删除 (PR 4)
...
// DREAMFORGE_SLIM: 5 个 ai_workspace_sessions fn 物理删除 (PR 4, ai_workspace_sessions_path / get_at / save_at / get / save)
...
mod tests {
    ...
    fn test_save_and_load_preserves_values() {
        let loaded = save_and_reload(Settings {
            ...
            sidebar_type_pluralization_enabled: Some(false),
            initial_h1_auto_rename_enabled: Some(false),
            // DREAMFORGE_SLIM: ai_features_enabled / default_ai_agent 物理删除 (PR 4)
            hide_gitignored_files: Some(false),
            multi_workspace_enabled: Some(true),
            all_notes_show_pdfs: Some(true),
        ...
        // DREAMFORGE_SLIM: ai_features_enabled / default_ai_agent assert 物理删除 (PR 4)
    ...
    fn test_save_trims_whitespace() {
        let loaded = save_and_reload(Settings {
            ...
            date_display_format: Some("  ISO  ".to_string()),
            note_width_mode: Some("  WIDE  ".to_string()),
            // DREAMFORGE_SLIM: default_ai_agent 物理删除 (PR 4)
            ..Default::default()
        });
        ...
        assert_eq!(loaded.note_width_mode.as_deref(), Some("wide"));
        // DREAMFORGE_SLIM: default_ai_agent assert 物理删除 (PR 4)
    }
    ...
    // DREAMFORGE_SLIM: 5 个 default_ai_agent test 物理删除 (PR 4)
    //   test_invalid_default_ai_agent_is_filtered
    //   test_opencode_default_ai_agent_is_preserved
    //   test_pi_default_ai_agent_is_preserved
    //   test_gemini_default_ai_agent_is_preserved
    //   test_hermes_default_ai_agent_is_preserved
    ...
    fn test_settings_path_returns_ok() {
        ...
        assert!(path.contains("com.biomatrix.dreamforge") || path.contains("com.laputa.app"));
    }
    ...
    fn test_preferred_settings_path_uses_tolaria_namespace() {
        ...
        assert!(result
            ...
            .to_str()
            .unwrap()
            .contains("com.biomatrix.dreamforge"));
    }

    // DREAMFORGE_SLIM: 3 个 test_ai_workspace_sessions 物理删除 (PR 4)
